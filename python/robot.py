...
class Robot:
    ...
    def update_state_estimate(self, camera_sees_tag):
        ...
        self.extended_kalman_filter.update(u_t, z_t, delta_t, camera_sees_tag)
    ...
    def control_loop(self, cmd_speed = 0, cmd_steering_angle = 0, logging_switch_on = False):
        try:
            prev_signal = list(self.camera_sensor_signal)
            # Get camera signal
            ...
            camera_sees_tag = not np.array_equal(self.camera_sensor_signal, prev_signal)
            ...
            self.update_state_estimate(camera_sees_tag)
            ...
            #print("ROBOT CONTROL LOOP ERROR:", e)
            import traceback

...
def get_file_data(filename):
    ...
    #theta_absolute = 0
    #theta_abs_list = []
    #for yaw in yaw_camera_list:
    #    theta_absolute += yaw
    #    theta_absolute = math.atan2(math.sin(theta_absolute), math.cos(theta_absolute))
    #    theta_abs_list.append(theta_absolute)
    ########
...
if False:
    filename = './data/robot_data_60_-20_25_02_26_04_00_03.pkl'
...
if False:
    filename = './data/robot_data_64_16_23_02_26_22_13_26.pkl'
    time_list, encoder_count_list, velocity_list, steering_angle_list, x_camera_list, y_camera_list, z_camera_list, yaw_camera_list= get_file_data(filename)
